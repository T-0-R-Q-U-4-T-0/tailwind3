...
const Escursione2 = ({
  ...
  costo = "35,00 €",
  immagine = "https://storage.googleapis.com/a1aa/image/lxoNvs24Lu1IO9NGR0BIJ-8UJSSmt1761L9Da-4aKdI.jpg"
}) => {
    return(
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <img
                src="https://storage.googleapis.com/a1aa/image/lxoNvs24Lu1IO9NGR0BIJ-8UJSSmt1761L9Da-4aKdI.jpg"
                alt="Vista di Murano con un faro e un battello sul canale"
            ...
            <div>
              ...
              <div className="flex items-center justify-between ">
                <button className="bg-purple-600 text-white font-bold py-4 px-8 rounded-full">
                  PRENOTA
                </button>
                <div className="text-right">
                  <p className="text-gray-500">Da</p>
                  <p className="text-2xl font-bold text-gray-800">{costo}</p>
                </div>
              </div>
            </div>
          </div>
